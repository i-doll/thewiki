//! Integration coverage for [`SqliteRevisionRepository`].
//!
//! Seeds a namespace + user + page per test, then exercises one or more
//! revision-repo methods.
...
async fn list_for_page_orders_newest_first_and_paginates() {
    ...
    // Newest-first ordering: revs[4] then revs[3].
